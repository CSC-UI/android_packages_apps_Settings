...
class AboutDevice : FrameLayout {
    ...
    init {
        ...
        val type = SystemProperties.get("ro.csc.gms.type")
        ...
        } else if(type.contains("GMS")){
            version + " " + context.getString(R.string.about_device_version_type_gms_core)
        } else {
        ...
        findViewById<LinearLayout>(R.id.deviceEdit).setOnClickListener {
            ...
            val dialogView: View = View.inflate(context, R.layout.csc_device_name_dialog, null)
